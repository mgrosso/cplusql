#ident "file_id $Id: ByteStripExpression.cpp,v 1.3 2005/10/19 08:41:19 mgrosso Exp $"
// ----------------------------------------------------------------------
// ----------------------------------------------------------------------
//
...
// Copyright (c) 2005 
// 
// $Id: ByteStripExpression.cpp,v 1.3 2005/10/19 08:41:19 mgrosso Exp $
// ----------------------------------------------------------------------
// ----------------------------------------------------------------------
...
)
{
    ...
    APPLOG_DBG("this=%lu d_=%lu", (unsigned long )this, (unsigned long)d_);
}
...
{
    APPLOG_DBG("this=%lu", (unsigned long )this );
    op_->notify();
    const char *src = op_->getRaw();
    buf_.reset("");
    APPLOG_DBG("empty buf_ %lu=%s, op_->getRaw()=%s", (unsigned long)buf_.get(), buf_.get(), src );
    ...
    {
        c=*s;
        APPLOG_DBG("c=%i actions_[c]=%i", (int)c, (int) actions_[static_cast<int>(c)]); 
